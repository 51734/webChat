...
;layui.define("view", function(e) {
    var a = layui.jquery
      ...
      , x = {
        ...
        sendAuthCode: function(e) {
            ...
            var i, t = e.seconds, n = function(l) {
                var s = a(e.elem);
                t--,
                t < 0 ? (s.removeClass(y).html("获取验证码"),
                t = e.seconds,
                clearInterval(i)) : s.addClass(y).html(t + "秒后重获"),
        ...
        tabsBodyChange: function(e) {
            x.tabsBody(e).addClass(c).siblings().removeClass(c),
            k.rollPage("auto", e)
        },
        resize: function(e) {
            var a = layui.router()
      ...
      , k = x.events = {
        ...
        serach: function(e) {
            e.off("keypress").on("keypress", function(a) {
                if (this.value.replace(/\s/g, "") && 13 === a.keyCode) {
                    ...
                    i += this.value,
                    t = t + ' <span style="color: #FF5722;">' + x.escape(this.value) + "</span>",
                    location.hash = x.correctRouter(i),
                    k.serach.keys || (k.serach.keys = {}),
                    k.serach.keys[x.tabsPage.index] = this.value,
                    this.value === k.serach.keys[x.tabsPage.index] && k.refresh(e),
                    this.value = ""
                }
            })
        },
        ...
        fullscreen: function(e) {
            ...
            if (t.hasClass(a)) {
                var n = document.body;
                n.webkitRequestFullScreen ? n.webkitRequestFullScreen() : n.mozRequestFullScreen ? n.mozRequestFullScreen() : n.requestFullScreen && n.requestFullscreen(),
                t.addClass(i).removeClass(a)
            } else {
                var n = document;
                n.webkitCancelFullScreen ? n.webkitCancelFullScreen() : n.mozCancelFullScreen ? n.mozCancelFullScreen() : n.cancelFullScreen ? n.cancelFullScreen() : n.exitFullscreen && n.exitFullscreen(),
        ...
        closeOtherTabs: function(e) {
            ...
            a(m).find("." + p + ":gt(0)").remove()) : (a(z).each(function(e, t) {
    ...
    !function() {
        ...
        e.theme ? x.theme(e.theme) : n.theme && x.initTheme(n.theme.initColorIndex),
    ...
    t.on("nav(layadmin-system-side-menu)", function(e) {
        e.siblings(".layui-nav-child")[0] && u.hasClass(g) && (x.sideFlexible("spread"),
    ...
    o.on("click", z, function() {
        ...
        x.tabsPage.index = i,
        "iframe" === e.attr("lay-attr") ? x.tabsBodyChange(i) : (F(e),
        void x.runResize())
    }),
